...
ALTER TABLE dbo.OrderData
ADD CONSTRAINT FK_ORDER_DATA_REFERENCE_8_ORDER FOREIGN KEY (OrderId) REFERENCES dbo.[Order] (OrderId)
GO;

ALTER TABLE dbo.OrderHeader
ADD CONSTRAINT FK_ORDER_HEADER_REFERENCE_9_ORDER FOREIGN KEY (OrderId) REFERENCES dbo.[Order] (OrderId)
GO;
